...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/eth8n/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/eth8n/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/eth8n/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/eth8n/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/eth8n/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/eth8n/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 1m, 10.699s               |  0m, 9.095s               | 
| `pg_normalized_batch`  | 0m, 32.055s               |  0m, 3.169s               | 
| `pg_denormalized`      | 0m, 23.820s               |  0m, 3.942s               | 
